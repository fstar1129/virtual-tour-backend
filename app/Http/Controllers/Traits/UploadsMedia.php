...
trait UploadsMedia
{
     ...
     * @var array
     */
    protected $audioMimes = ['audio/mpeg', 'application/octet-stream'];
    ...
    public function storeImage($file, $dir, $ext = null, $sizeUp = false)
    {
        ...
        if ($sizeUp && ($image->height() < $thumbSize || $image->width() < $thumbSize)) {
            ...
            throw new ImageTooSmallException("Error uploading image. Please make sure images are at least 700 x 400 pixels, in landscape orientation, and in high resolution for image quality.");
        }
