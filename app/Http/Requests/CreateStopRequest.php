...
class CreateStopRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'description' => 'nullable|string|max:16000|min:250',
    ...
    {
        return [
            'title.max' => 'Stop title must be less than 35 characters.',
            'title.*' => 'A Stop Title is required.',
            'description.max' => 'Stop description is too long.',
            'description.min' => 'Stop description must be more than 250 characters.',
